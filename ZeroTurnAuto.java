...
public class ZeroTurnAuto extends LinearOpMode7582 {
    ...
    public void runOpMode() {
        ...
        try {
            ...
            if (opModeIsActive()) runtime.reset();
            if (opModeIsActive()) Functions.wait(this, 0.5);
            if (opModeIsActive()) turn(50, 1);
            ...
            if (opModeIsActive()) driveDistance(1, -2, Functions.Units.FEET);
    ...
    private int driveRotations2(double rotations, double speed){
        ...
        int[] targets = new int[] {
                hardware.leftDrive.getCurrentPosition() + ((int) (rotations * 1440)),
